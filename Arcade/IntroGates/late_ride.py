...
Input/Output
    ...
    [input] integer n
        ...
        The duration of your ride, in minutes. It is guaranteed that you've
...
def lateRide(timer_minutes):
    hours = timer_minutes / 60
    minutes = timer_minutes - (hours * 60)
