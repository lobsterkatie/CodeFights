"""
INTRO GATES / SEATS IN THEATER

Your friend advised you to see a new performance in the most popular theater in
...
view (even if only for a couple of seconds) of all the people who sit behind
you and in your column or the columns to your left. To gain some courage, you
decide to calculate the number of such people and see if you can possibly make
...
def seatsInTheater(num_cols, num_rows, col, row):

    rows_behind = num_rows - row
    cols_to_left = num_cols - col

    # the +1 is for the column directly behind you
    blocked_folks = rows_behind * (cols_to_left + 1)

    return blocked_folks
