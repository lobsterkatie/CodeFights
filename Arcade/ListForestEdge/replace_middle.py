"""
LIST FOREST EDGE / REPLACE MIDDLE
...
Input/Output
    ...
    [output] array.integer
        ...
        arr with its middle replaced by a single element, or the initial array
        if the middle consisted of a single element to begin with.
"""
